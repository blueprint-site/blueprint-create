    ...
    var AssertionError = function(_Error, _inspect$custom) {
      ...
      _createClass(AssertionError2, [{
        ...
        value: function value(recurseTimes, ctx2) {
          return inspect(this, _objectSpread(_objectSpread({}, ctx2), {}, {
            customInspect: false,
            depth: 0
          }));
        }
...
// node_modules/prismarine-nbt/zigzag.js
var require_zigzag = __commonJS({
  "node_modules/prismarine-nbt/zigzag.js"(exports2, module2) {
    function sizeOfVarInt(value) {
...
var require_nbt2 = __commonJS({
  "node_modules/prismarine-nbt/nbt.js"(exports2, module2) {
    ...
    var varintJson = JSON.stringify(require_nbt_varint()).replace(
      /([if][0-7]+)/g,
      "l$1"
    );
    function addTypesToCompiler(type, compiler) {
      ...
      compiler.addTypes(require_zigzag().compiler);
      let proto = beNbtJson;
    ...
    function addTypesToInterpreter(type, compiler) {
      ...
      compiler.addTypes(require_zigzag().interpret);
      let proto = beNbtJson;
      if (type === "littleVarint") {
        proto = varintJson;
      } else if (type === "little") {
    ...
    function equal(nbt1, nbt2) {
      if (nbt1.type !== nbt2.type)
        return false;
      if (nbt1.type === "compound") {
        const nbt1Keys = Object.keys(nbt1.value);
        const nbt2Keys = Object.keys(nbt2.value);
        if (nbt1Keys.length !== nbt2Keys.length)
          return false;
        for (const key of nbt1Keys) {
          if (!equal(nbt1.value[key], nbt2.value[key]))
            return false;
        }
        return true;
      }
      if (nbt1.type === "list") {
        if (nbt1.value.length !== nbt2.value.length)
          return false;
        for (let i = 0; i < nbt1.value.length; i++) {
          if (!equal(nbt1.value[i], nbt2.value[i]))
            return false;
        }
        return true;
      }
