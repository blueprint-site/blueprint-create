...
export default function ProfileImageCleanup({ currentAvatarUrl }: ProfileImageCleanupProps) {
  ...
  const cleanupOrphanedFiles = async () => {
    ...
    try {
      ...
      logMessage(
        `Cleanup complete: Deleted ${deletedCount} files, skipped ${skippedCount}`,
        0,
        'action'
      );
      alert(
  ...
  return (
    <div className='flex items-center gap-2 rounded-md border bg-yellow-50 p-2 dark:bg-yellow-900/20'>
