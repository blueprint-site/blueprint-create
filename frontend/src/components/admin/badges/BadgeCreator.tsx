    ...
    <div className='grid gap-6 lg:grid-cols-2'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Design a custom badge with various styles and effects</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                            ...
                            {BadgeRarityEnum.options.map((rarity) => (
                              <SelectItem key={rarity} value={rarity}>
                                <div className='flex items-center gap-2'>
                                  <div
                                    className={cn('h-3 w-3 rounded-full', rarityColors[rarity])}
                                  />
                    ...
                    render={({ field }) => (
                      <FormItem className='flex flex-row items-center justify-between rounded-lg border p-3'>
                        <div className='space-y-0.5'>
                          ...
                          <FormDescription>Enable pulse animation for the badge</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            <div
              className={cn(
                'flex min-h-[200px] items-center justify-center rounded-lg p-8',
            ...
            <div className='space-y-2'>
              ...
              <div className='space-y-1 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span>
                    {[watchedValues.hasGlow && 'Glow', watchedValues.isAnimated && 'Animated']
                      .filter(Boolean)
                      .join(', ') || 'None'}
                  </span>
                </div>
