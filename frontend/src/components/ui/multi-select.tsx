...
interface MultiSelectContextProps {
  value: string[];
  onValueChange: (value: string) => void; // Changed from 'any' to 'string'
  open: boolean;
...
const MultiSelector = ({
  ...
  const handleKeyDown = useCallback(
    ...
    [value, inputValue, activeIndex, loop, dir, isValueSelected, selectedValue, onValueChangeHandler],
  );
...
>((props, ref) => {
  ...
  return (
    <div ref={ref} {...restProps} className="relative">
      {open && children}
    </div>
  );
});
