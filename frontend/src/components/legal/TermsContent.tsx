    ...
    <>
      ...
      <section className='mb-8'>
        ...
        <p className='text-foreground-muted'>
          By accessing or using Blueprint (&quot;the Service&quot;), you agree to be bound by these
          Terms of Service. If you do not agree to all the terms and conditions, do not use the
          Service.
        </p>
      </section>
      ...
      <section className='mb-8'>
        ...
        <p className='text-foreground-muted'>
          ...
          and warrant that you meet this requirement and have the capacity to enter into these
          terms.
        </p>
      </section>
      ...
      <section className='mb-8'>
        ...
        <ul className='text-foreground-muted mb-4 list-disc pl-6'>
          ...
          <li>
            You grant us a non-exclusive, worldwide, royalty-free license to display and distribute
            your User Content through the Service
          </li>
      ...
      <section className='mb-8'>
        ...
        <ul className='text-foreground-muted mb-4 list-disc pl-6'>
          ...
          <li>
            BLUEPRINT IS NOT AFFILIATED WITH THE CREATE MOD TEAM OR ANY OF ITS ADDONS IN ANY WAY.
          </li>
        </ul>
      ...
      <section className='mb-8'>
        ...
        <p className='text-foreground-muted'>
          ...
          <a href='/legal?tab=privacy' className='text-primary hover:underline'>
            Privacy Policy
          </a>
