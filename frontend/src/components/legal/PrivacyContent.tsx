    ...
    <>
      ...
      <section className='mb-8'>
        ...
        <p className='text-foreground-muted'>
          This privacy policy explains how we collect and use your data while using Blueprint. We
          take your privacy seriously and are committed to protecting your personal information.
        </p>
      </section>
