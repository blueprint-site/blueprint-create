...
function AddonsSlideshow() {
    return (
        ...
        <div className="carousel-inner">
            ...
            <img src="../assets/banners/banner1.webp" className="d-block w-100" alt="..."/>
            </div>
            <div className="carousel-item">
            <img src="../assets/banners/banner2.webp" className="d-block w-100" alt="..."/>
            </div>
            <div className="carousel-item">
            <img src="../assets/banners/banner3.webp" className="d-block w-100" alt="..."/>
            </div>
        </div>
