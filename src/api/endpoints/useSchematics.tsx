    ...
    return useMutation({
        mutationFn: async (schematic: Partial<Schematic>) => {
            ...
            const serializedSchematics = {
                ...
                game_versions: schematic.game_versions ? JSON.stringify(schematic.game_versions) : undefined,
                create_versions: schematic.create_versions ? JSON.stringify(schematic.create_versions) : undefined,
