    ...
    <div className="container mx-auto px-4 py-8">
      <Card className="max-w-4xl mx-auto">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground mb-8">Last Modified: January 24, 2025</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground uppercase">TO THE MAXIMUM EXTENT PERMITTED BY LAW, WE SHALL NOT BE LIABLE FOR ANY:</p>
            <ul className="list-disc pl-6 text-muted-foreground">
