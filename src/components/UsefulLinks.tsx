...
function UsefulLinks() {
    return (
        <div className="useful-links">
            ...
            <br />
            <a href="https://modrinth.com/mod/create"><img src={CreateLogo} alt="" />Create Mod (Forge)</a>
            <br />
            <a href="https://modrinth.com/mod/create-fabric"><img src={CreateLogo} alt="createmodlogo" />Create Mod (Fabric)</a>
            </center>
        </div>
    );
}
