...
function AddonsSlideshow() {
  ...
  const updateSideBoxContent = (index: number) => {
    switch (index) {
      case 0:
        return (
          <div>
            <LazyImage className="sideboximage" src="https://cdn.modrinth.com/data/Dq3STxps/011f13a3eaf73d06a26b60a3a6ba858d3735815d.png" alt="" />
      ...
      case 1:
        return (
          <div>
            <LazyImage className="sideboximage" src="https://cdn.modrinth.com/data/ZzjhlDgM/23d42e3d1c878cb77f9e74a3f78fed2d011ed937.png" alt="" />
      ...
      case 2:
        return (
          <div>
            <LazyImage className="sideboximage" src="https://cdn.modrinth.com/data/IAnP4np7/0c69bfc4fb1df010c35c02f94ebc275ba0fa9bae.png" alt="" />
      ...
      case 3:
        return (
          <div>
            <LazyImage className="sideboximage" src="https://cdn.modrinth.com/data/GmjmRQ0A/9af7f38727e4c1dc30c67fefd80b15000a2b8c07.png" alt="" />
      ...
      case 4:
        return (
          <div>
            <LazyImage className="sideboximage" src="https://cdn.modrinth.com/data/GWp4jCJj/a3c3d5087ac30256a7e98309e322ab4766508ec7.png" height={100} alt="" />
  ...
  return (
    <SlideshowContainer className="home-slideshow-container">
      <LazyImage src={images[currentIndex]} alt="" className={"slideshowimage " + (currentIndex === 0 ? "home-slideshow-image visible" : "home-slideshow-image hidden")} />
