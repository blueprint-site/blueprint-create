...
const FeatureIcon = ({ src, alt, label, url }: FeatureIconProps) => (
    <a href={url} className='mt-4 flex flex-col text-foreground items-center transition-transform duration-200 hover:scale-110' target="_blank" rel="noopener noreferrer">
        <img
            loading='lazy'
            src={src}
            alt={alt}
