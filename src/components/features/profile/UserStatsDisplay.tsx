  ...
  return (
    <Card className={className}>
      ...
      <CardContent className='space-y-6'>
        ...
        {/* Content Stats */}
        <div>
          <h3 className='text-sm font-medium text-muted-foreground mb-3'>Content Created</h3>
        ...
        {/* Quality Metrics */}
        <div>
          <h3 className='text-sm font-medium text-muted-foreground mb-3'>Quality Metrics</h3>
          <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
            <StatCard
              icon={<Star className='h-4 w-4 text-yellow-500' />}
        ...
        {(stats.reached100Downloads || stats.reached1000Downloads) && (
          <div>
            <h3 className='text-sm font-medium text-muted-foreground mb-3'>Milestones Achieved</h3>
            <div className='space-y-2'>
              {stats.reached100Downloads && (
                <div className='flex items-center gap-2 p-2 rounded bg-muted/30'>
                  <Trophy className='h-4 w-4 text-yellow-500' />
                  <span className='text-sm'>100 Downloads - {formatDate(stats.reached100Downloads)}</span>
                </div>
              )}
              {stats.reached1000Downloads && (
                <div className='flex items-center gap-2 p-2 rounded bg-muted/30'>
                  <Trophy className='h-4 w-4 text-yellow-500' />
                  <span className='text-sm'>1000 Downloads - {formatDate(stats.reached1000Downloads)}</span>
                </div>
              )}
            </div>
          </div>
