...
export function MissionSection() {
  ...
  return (
    <Card className='bg-surface-2 relative mb-8 px-4 overflow-hidden' aria-labelledby='mission'>
      ...
      <CardContent>
        ...
        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3'>
          {cards.map((card) => (
            <motion.div
              key={card.id}
              className='border-border hover:border-primary flex flex-col rounded-lg border p-6 transition-colors hover:bg-foreground/5'
