...
export const RewardRuleDialog: React.FC<RewardRuleDialogProps> = ({
  isOpen,
  onClose,
  rule,
}) => {
  ...
  const onSubmit = async (data: Record<string, unknown>) => {
    try {
      ...
      const processedData = {
        ...data,
        conditions: typeof data.conditions === 'object' ? JSON.stringify(data.conditions) : data.conditions,
      };
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Message shown when badge is earned"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Maximum times this badge can be earned
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Days to wait before earning again
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
