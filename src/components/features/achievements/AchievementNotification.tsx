  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <motion.div
            className="relative bg-background border-2 border-primary/20 rounded-lg shadow-2xl p-6 max-w-md w-full pointer-events-auto"
            initial={{ rotate: -2 }}
            animate={{ rotate: 0 }}
          ...
          >
            ...
            <div className="text-center">
              <motion.div
                ...
                className="mb-4"
              >
                <div className="inline-block p-4 rounded-full bg-gradient-to-br from-primary/20 to-primary/10">
                  {badge.iconUrl ? (
                    <img
                      src={badge.iconUrl}
                      alt={badge.name}
                    ...
                    <div className={`p-4 rounded-full bg-gradient-to-br ${getTierColor(badge.tier)}`}>
