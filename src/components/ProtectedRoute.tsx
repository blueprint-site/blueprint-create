...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  useMinimalLoading = false,
    ...
    const [isLoading, setIsLoading] = useState<boolean>(initialAuth === null);
        ...
        try {
            ...
            if (requiredRole) {
                ...
                if (roleToTeamId[requiredRole]) {
                    try {
                        const teamMemberships = await teams.listMemberships({teamId:roleToTeamId[requiredRole]});
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className=" bg-destructive/30 p-10">
                    ...
                    <p className="text-sm mt-1 opacity-80 dark:opacity-50 font-minecraft">Required role: admin</p>
                </div>
            </div>
        );
    }
